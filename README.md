...
+---------------+------------+---------------+----------+------+-------+-------+-----------+
| Coconut oil   | 234        | VVD           | 1        | LTRS | 200   | 0     | OUT OF STOCK |
+---------------+------------+---------------+----------+------+-------+-------+-----------+
 ```
...
+---------+----------+------------+-------------+----------------+--------------+------------+---------------+--------------+
| USER_ID | ORDER_ID | PRODUCT_ID | NO_OF_ITEMS | PRICE_PER_ITEM | TOTAL_AMOUNT | ORDER_DATE | DELIVERY_DATE | ORDER_STATUS |
+---------+----------+------------+-------------+----------------+--------------+------------+---------------+--------------+
| 1101    | 1001     | 231        | 5           | 400            | 2000         | 02-JAN-20  | 07-JAN-20     | ORDERED      |
+---------+----------+------------+-------------+----------------+--------------+------------+---------------+--------------+
| 1102    | 1002     | 232        | 10          | 200            | 2000         | 02-JAN-20  | 08-JAN-20     | ORDERED      |
+---------+----------+------------+-------------+----------------+--------------+------------+---------------+--------------+
| 1103    | 1003     | 233        | 2           | 900            | 1800         | 02-JAN-20  | 10-JAN-20     | ORDERED      |
|         |          |            |             |                |              |            |               |              |
+---------+----------+------------+-------------+----------------+--------------+------------+---------------+--------------+
...
| USER_ID | ORDER_ID | PRODUCT_ID | NO_OF_ITEMS | PRICE_PER_ITEM | TOTAL_AMOUNT | ORDER_DATE | DELIVERY_DATE | ORDER_STATUS |
+---------+----------+------------+-------------+----------------+--------------+------------+---------------+--------------+
| 1101    | 1001     | 231        | 5           | 400            | 0            | 02-JAN-20  |  -            | CANCELLED    |
+---------+----------+------------+-------------+----------------+--------------+------------+---------------+--------------+
| 1102    | 1002     | 232        | 10          | 200            | 2000         | 02-JAN-20  | 08-JAN-20     | ORDERED      |
+---------+----------+------------+-------------+----------------+--------------+------------+---------------+--------------+
| 1103    | 1003     | 233        | 2           | 900            | 1800         | 02-JAN-20  | 10-JAN-20     | ORDERED      |
...
+-----------+----------+---------------+---------------+----------+-------------+--------------+------------+---------------+-----------------------------------+--------------+
| USER_NAME | ORDER_ID | PRODUCT_NAME  | MANUFACTURER  | QUANTITY | NO_OF_ITEMS | TOTAL_AMOUNT | ORDER_DATE | DELIVERY_DATE | DELIVERY_ADDRESS                  | ORDER_STATUS |
+-----------+----------+---------------+---------------+----------+-------------+--------------+------------+---------------+-----------------------------------+--------------+
| Ravi      | 1001     | Coffee Powder | Nescafe       | .5       | 5           | 2000         | 02-JAN-20  | 07-JAN-20     | 243,Bharathi nagar Chennai-600043 | ORDERED      |
+-----------+----------+---------------+---------------+----------+-------------+--------------+------------+---------------+-----------------------------------+--------------+
| Kumar     | 1002     | Tea Powder    | Tata Tea Gold | 1        | 10          | 2000         | 02-JAN-20  | 08-JAN-20     | 345,Kumaran nagar Chennai-600048  | ORDERED      |
+-----------+----------+---------------+---------------+----------+-------------+--------------+------------+---------------+-----------------------------------+--------------+
| Suresh    | 1003     | Cashews       | Fruitri       | 1        | 2           | 1800         | 02-JAN-20  | 10-JAN-20     | 64,Gajendra nagar Chennai-610045  | ORDERED      |
+-----------+----------+---------------+---------------+----------+-------------+--------------+------------+---------------+-----------------------------------+--------------+
